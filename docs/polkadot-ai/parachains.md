...
- Word Count: 1779; Token Estimate: 2786
...
- Word Count: 1700; Token Estimate: 2994
...
- Word Count: 2288; Token Estimate: 4051
...
- Word Count: 827; Token Estimate: 1630
...
- Word Count: 2635; Token Estimate: 4956
...
Download the pre-built binary from the [Polkadot SDK release](https://github.com/paritytech/polkadot-sdk/releases/tag/polkadot-stable2512-1){target=\_blank} (recommended):

=== "macOS"

    ```bash
    curl -L -o frame-omni-bencher https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/frame-omni-bencher-aarch64-apple-darwin
...
=== "Ubuntu"
    ...
    ```bash
    curl -L -o frame-omni-bencher https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/frame-omni-bencher
    chmod +x frame-omni-bencher
    sudo mv frame-omni-bencher /usr/local/bin/
    ```
...
```bash
curl -L https://raw.githubusercontent.com/paritytech/polkadot-sdk/refs/tags/polkadot-stable2512-1/substrate/.maintain/frame-weight-template.hbs \
...
- Word Count: 910; Token Estimate: 1397
...
- Word Count: 1145; Token Estimate: 2098
...
- Word Count: 2216; Token Estimate: 3777
...
- Word Count: 2068; Token Estimate: 4013
...
!!! tip
    This documentation explains the features of Chopsticks version `1.2.7`. Make sure you're using the correct version to match these instructions.
...
=== "npm"
    ...
    ```bash
    npm i -g @acala-network/chopsticks@1.2.7
    ```

=== "pnpm"

    ```bash
    pnpm add -g @acala-network/chopsticks@1.2.7
    ```

=== "yarn"

    ```bash
    yarn global add @acala-network/chopsticks@1.2.7
    ```
...
=== "npm"
    ...
    ```bash
    npm i @acala-network/chopsticks@1.2.7
    ```

=== "pnpm"

    ```bash
    pnpm add @acala-network/chopsticks@1.2.7
    ```

=== "yarn"

    ```bash
    yarn add @acala-network/chopsticks@1.2.7
    ```
...
- Resolved Markdown: https://docs.polkadot.com/ai/pages/parachains-runtime-maintenance-coretime-renewal.md
...
- Word Count: 2114; Token Estimate: 3449
...
- Word Count: 3293; Token Estimate: 6613
...
- Word Count: 903; Token Estimate: 1682
...
- Word Count: 1114; Token Estimate: 2127
...
This guide demonstrates how to deploy an ERC-20 contract on Polkadot Hub TestNet using [Hardhat](https://hardhat.org/){target=\_blank}, an Ethereum development environment. The ERC-20 contract can be retrieved from OpenZeppelin's [GitHub repository](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/v5.5.0/contracts/token/ERC20){target=\_blank} or generated with the [OpenZeppelin Contracts Wizard for Polkadot](https://wizard.openzeppelin.com/polkadot){target=\_blank}.
...
- Word Count: 889; Token Estimate: 1474
...
This tutorial covers deploying an ERC-20 contract on Polkadot Hub TestNet using [Remix IDE](https://remix.ethereum.org/){target=\_blank}, a web-based development tool. The ERC-20 contract can be retrieved from OpenZeppelin's [GitHub repository](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/v5.5.0/contracts/token/ERC20){target=\_blank} or generated with the [OpenZeppelin Contracts Wizard for Polkadot](https://wizard.openzeppelin.com/polkadot){target=\_blank}.
...
3. Now, paste the following ERC-20 contract code into `MyToken.sol`:
    ...
    !!! tip
        The [OpenZeppelin Contracts Wizard for Polkadot](https://wizard.openzeppelin.com/polkadot){target=\_blank} was used to generate this example ERC-20 contract. Use it to customize and generate your own ERC-20, ERC-721, or other OpenZeppelin-standard contracts for Polkadot Hub.
...
- Word Count: 695; Token Estimate: 1201
...
- Word Count: 998; Token Estimate: 1892
...
This guide demonstrates how to deploy an [ERC-721](https://eips.ethereum.org/EIPS/eip-721){target=\_blank} NFT contract to [Polkadot Hub](/smart-contracts/overview/#smart-contract-development){target=\_blank} TestNet. You'll use OpenZeppelin's battle-tested [NFT implementation](https://github.com/OpenZeppelin/openzeppelin-contracts){target=\_blank} and [Hardhat](https://hardhat.org/docs/getting-started){target=\_blank}, a comprehensive development environment with built-in testing, debugging, and deployment capabilities. You can generate a custom NFT contract with the [OpenZeppelin Contracts Wizard for Polkadot](https://wizard.openzeppelin.com/polkadot){target=\_blank}, then use it in this Hardhat workflow. Hardhat uses standard Solidity compilation to generate EVM bytecode, making it fully compatible with Polkadot Hub's EVM environment.
...
- Word Count: 436; Token Estimate: 849
...
- Word Count: 2357; Token Estimate: 4126
...
- Word Count: 482; Token Estimate: 722
...
- Word Count: 1294; Token Estimate: 2456
...
- Word Count: 3364; Token Estimate: 5294
...
- Word Count: 1447; Token Estimate: 2880
...
You can install Chopsticks globally or locally in your project. Choose the option that best fits your development workflow. This documentation explains the features of Chopsticks version `1.2.7`. Make sure you're using the correct version to match these instructions.
...
- Word Count: 590; Token Estimate: 2266
...
- [Polkadot Wiki - Parachains](https://wiki.polkadot.com/learn/learn-parachains/){target=\_blank}
...
- Word Count: 909; Token Estimate: 2561
...
- Word Count: 975; Token Estimate: 1506
...
- Word Count: 3611; Token Estimate: 5335
...
Many tools in the Polkadot SDK ecosystem, such as [`subkey`](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-1/substrate/bin/utils/subkey){target=\_blank}, allow you to implicitly specify an account using a derivation path such as `//Alice`.
...
- Word Count: 3325; Token Estimate: 5355
...
- Word Count: 585; Token Estimate: 775
...
- Word Count: 3850; Token Estimate: 9587
...
- Word Count: 814; Token Estimate: 1311
...
- Word Count: 1486; Token Estimate: 2784
...
- Word Count: 1517; Token Estimate: 2085
...
- Word Count: 627; Token Estimate: 919
...
- Word Count: 1345; Token Estimate: 2106
...
- Word Count: 1019; Token Estimate: 1616
...
- **[Democracy pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-1/substrate/frame/democracy/src){target=\_blank}**: Handles administration of general stakeholder voting.
...
- Word Count: 1549; Token Estimate: 2291
...
- Word Count: 889; Token Estimate: 1434
...
- Word Count: 1104; Token Estimate: 1841
...
- Word Count: 1759; Token Estimate: 2551
...
- Word Count: 873; Token Estimate: 1299
...
- Word Count: 1029; Token Estimate: 1762
...
- Word Count: 816; Token Estimate: 1237
...
Download the pre-built `polkadot-omni-node` binary from the [Polkadot SDK release](https://github.com/paritytech/polkadot-sdk/releases/tag/polkadot-stable2512-1){target=\_blank} (recommended):

=== "macOS"

    ```bash
    curl -L -o polkadot-omni-node https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/polkadot-omni-node-aarch64-apple-darwin
...
=== "Ubuntu"
    ...
    ```bash
    curl -L -o polkadot-omni-node https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/polkadot-omni-node
    chmod +x polkadot-omni-node
    sudo mv polkadot-omni-node /usr/local/bin/
    ```
...
- Word Count: 4194; Token Estimate: 6509
...
- Word Count: 2742; Token Estimate: 6310
...
- Word Count: 607; Token Estimate: 996
...
- Word Count: 1005; Token Estimate: 1390
...
- Word Count: 1000; Token Estimate: 1512
...
- Word Count: 4719; Token Estimate: 10142
...
If you need to use a custom binary, ensure the binary is available in your PATH. You can also specify the binary path in the network configuration file. The following example uses the [parachain template](https://github.com/paritytech/polkadot-sdk-parachain-template){target=\_blank}:
...
!!! note
    When using the parachain template v0.0.5, ensure you use a compatible relay chain binary. The recommended version is `polkadot-stable2512-1`, which you can download from the [Polkadot SDK releases](https://github.com/paritytech/polkadot-sdk/releases/tag/polkadot-stable2512-1){target=\_blank}.
...
- Word Count: 811; Token Estimate: 1164
...
- Word Count: 1766; Token Estimate: 2935
...
- [**Chain spec builder**](https://crates.io/crates/staging-chain-spec-builder/16.0.0){target=\_blank} - a Polkadot SDK utility for generating chain specifications. Refer to the [Generate Chain Specs](/parachains/launch-a-parachain/deploy-to-polkadot/#generate-the-chain-specification){target=\_blank} documentation for detailed usage
- [**Polkadot Omni Node**](https://crates.io/crates/polkadot-omni-node/0.13.0){target=\_blank} - a white-labeled binary, released as a part of Polkadot SDK, that can act as the collator of a parachain in production, with all the related auxiliary functionalities that a normal collator node has: RPC server, archiving state, etc. It can also run the Wasm blob of the parachain locally for testing and development

Download the pre-built binaries from the [Polkadot SDK release](https://github.com/paritytech/polkadot-sdk/releases/tag/polkadot-stable2512-1){target=\_blank} (recommended):

=== "macOS"

    ```bash
    curl -L -o chain-spec-builder https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/chain-spec-builder-aarch64-apple-darwin
    curl -L -o polkadot-omni-node https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/polkadot-omni-node-aarch64-apple-darwin
...
=== "Ubuntu"
    ...
    ```bash
    curl -L -o chain-spec-builder https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/chain-spec-builder
    curl -L -o polkadot-omni-node https://github.com/paritytech/polkadot-sdk/releases/download/polkadot-stable2512-1/polkadot-omni-node
    chmod +x chain-spec-builder polkadot-omni-node
    sudo mv chain-spec-builder polkadot-omni-node /usr/local/bin/
    ```
...
- Word Count: 203; Token Estimate: 1041
...
- Word Count: 578; Token Estimate: 901
...
- Word Count: 2311; Token Estimate: 3929
...
For a complete implementation example of multi-block migrations, refer to the [official example](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-1/substrate/frame/examples/multi-block-migrations){target=\_blank} in the Polkadot SDK.
...
- Word Count: 936; Token Estimate: 1679
...
- Word Count: 3333; Token Estimate: 4710
...
- Word Count: 751; Token Estimate: 1151
...
- Word Count: 2917; Token Estimate: 4469
...
The [Transaction Payment pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-1/substrate/frame/transaction-payment){target=\_blank} provides the basic logic for calculating the inclusion fee. You can also use the Transaction Payment pallet to:
...
- Limits enable you to enforce constant or configurable limits on specific operations. For example, the default [Staking pallet](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-1/substrate/frame/staking){target=\_blank} only allows nominators to nominate 16 validators to limit the complexity of the validator election process.
...
- [Custom weights for the Example pallet](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512-1/substrate/frame/examples/basic/src/weights.rs){target=\_blank}
...
- Word Count: 2663; Token Estimate: 5962
...
- Word Count: 1278; Token Estimate: 2037
...
- Word Count: 860; Token Estimate: 1393
