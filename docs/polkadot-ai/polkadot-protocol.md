...
- Word Count: 996; Token Estimate: 1802
...
- Word Count: 776; Token Estimate: 1223
...
To view the complete list of which pallets are included in Bridge Hub, visit the Subscan [Runtime Modules](https://bridgehub-polkadot.subscan.io/runtime){target=\_blank} page. Alternatively, the source code for those pallets can be found in the Polkadot SDK [Snowbridge Pallets](https://github.com/paritytech/polkadot-sdk/tree/polkadot-stable2512-1/bridges/snowbridge/pallets){target=\_blank} repository.
...
- Go over the Bridge Hub README in the Polkadot SDK [Bridge-hub Parachains](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512-1/cumulus/parachains/runtimes/bridge-hubs/README.md){target=\_blank} repository.
- Take a deeper dive into bridging architecture in the Polkadot SDK [High-Level Bridge](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512-1/bridges/docs/high-level-overview.md){target=\_blank} documentation.
...
- Word Count: 290; Token Estimate: 419
...
- Word Count: 1048; Token Estimate: 1446
...
This technical advancement enables parachains to process multiple blocks within a single relay chain block, significantly increasing throughput capabilities. By leveraging [Agile Coretime](/reference/polkadot-hub/consensus-and-security/agile-coretime/){target=\_blank}, parachains can dynamically adjust their processing capacity based on demand, creating an efficient and responsive infrastructure for high-throughput applications.
...
- Word Count: 579; Token Estimate: 854
...
- Word Count: 1184; Token Estimate: 1728
...
- Word Count: 452; Token Estimate: 658
...
- Word Count: 1759; Token Estimate: 2385
...
- [GRANDPA Pallet](https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2512-1/substrate/frame/grandpa/src/lib.rs){target=\_blank}
